...
extern Il2CppCodeGenString* _stringLiteral2188473637;
...
#define GameObject_GetComponent_TisDone_GameController_t2490533223_m3515554710(__this, method) ((  Done_GameController_t2490533223 * (*) (GameObject_t1756533147 *, const MethodInfo*))GameObject_GetComponent_TisIl2CppObject_m2812611596_gshared)(__this, method)
...
IL_0056:
	{
		...
		GameController_t3607102586 * L_9 = __this->get_U24this_0();
		NullCheck(L_9);
		...
		GameController_t3607102586 * L_13 = __this->get_U24this_0();
		NullCheck(L_13);
		Vector3_t2243707580 * L_14 = L_13->get_address_of_spawnValues_3();
		float L_15 = L_14->get_y_2();
		GameController_t3607102586 * L_16 = __this->get_U24this_0();
		NullCheck(L_16);
		Vector3_t2243707580 * L_17 = L_16->get_address_of_spawnValues_3();
		float L_18 = L_17->get_z_3();
		Vector3__ctor_m2638739322((&V_2), L_12, L_15, L_18, /*hidden argument*/NULL);
		Quaternion_t4030073918  L_19 = Quaternion_get_identity_m1561886418(NULL /*static, unused*/, /*hidden argument*/NULL);
		V_3 = L_19;
		GameController_t3607102586 * L_20 = __this->get_U24this_0();
		NullCheck(L_20);
		GameObject_t1756533147 * L_21 = L_20->get_hazard_2();
		Vector3_t2243707580  L_22 = V_2;
		Quaternion_t4030073918  L_23 = V_3;
		IL2CPP_RUNTIME_CLASS_INIT(Object_t1021602117_il2cpp_TypeInfo_var);
		Object_Instantiate_TisGameObject_t1756533147_m3064851704(NULL /*static, unused*/, L_21, L_22, L_23, /*hidden argument*/Object_Instantiate_TisGameObject_t1756533147_m3064851704_MethodInfo_var);
		int32_t L_24 = V_1;
...
IL_00c0:
	{
		...
		NullCheck(L_26);
		int32_t L_27 = L_26->get_hazardCount_4();
	...
	}
	{
		...
		NullCheck(L_28);
		float L_29 = L_28->get_waveWait_7();
		...
		WaitForSeconds__ctor_m1990515539(L_30, L_29, /*hidden argument*/NULL);
...
IL_00fb:
	{
		GameController_t3607102586 * L_32 = __this->get_U24this_0();
		NullCheck(L_32);
		bool L_33 = L_32->get_gameOver_11();
		if (!L_33)
		{
			goto IL_0131;
		}
	}
	{
		...
		NullCheck(L_34);
		GUIText_t2411476300 * L_35 = L_34->get_restartText_9();
		NullCheck(L_35);
		GUIText_set_text_m3758377277(L_35, _stringLiteral2188473637, /*hidden argument*/NULL);
		GameController_t3607102586 * L_36 = __this->get_U24this_0();
		NullCheck(L_36);
		L_36->set_restart_12((bool)1);
		goto IL_0136;
	}
...
extern "C"  void PlayerController_Update_m4228472513 (PlayerController_t4148409433 * __this, const MethodInfo* method)
{
	...
	}
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(Input_t1785128008_il2cpp_TypeInfo_var);
		bool L_1 = Input_GetButton_m38251721(NULL /*static, unused*/, _stringLiteral3645101709, /*hidden argument*/NULL);
		if (!L_1)
		{
			goto IL_006a;
		}
	}
	{
		...
		float L_3 = __this->get_nextFire_10();
	...
	}
	{
		...
		float L_5 = __this->get_fireRate_9();
		__this->set_nextFire_10(((float)((float)L_4+(float)L_5)));
		GameObject_t1756533147 * L_6 = __this->get_shot_7();
		Transform_t3275118058 * L_7 = __this->get_shotSpawn_8();
		NullCheck(L_7);
		Vector3_t2243707580  L_8 = Transform_get_position_m1104419803(L_7, /*hidden argument*/NULL);
		Transform_t3275118058 * L_9 = __this->get_shotSpawn_8();
		NullCheck(L_9);
		...
		AudioSource_t1135106623 * L_11 = __this->get_audioSource_6();
		NullCheck(L_11);
...
extern "C"  void PlayerController_FixedUpdate_m1756102567 (PlayerController_t4148409433 * __this, const MethodInfo* method)
{
	...
	memset(&V_5, 0, sizeof(V_5));
	{
		...
		Rigidbody_t4233889191 * L_4 = Component_GetComponent_TisRigidbody_t4233889191_m520013213(__this, /*hidden argument*/Component_GetComponent_TisRigidbody_t4233889191_m520013213_MethodInfo_var);
		__this->set_rb_5(L_4);
		Rigidbody_t4233889191 * L_5 = __this->get_rb_5();
		...
		Rigidbody_t4233889191 * L_10 = __this->get_rb_5();
		NullCheck(L_10);
		...
		Rigidbody_t4233889191 * L_18 = __this->get_rb_5();
		NullCheck(L_18);
		...
		Rigidbody_t4233889191 * L_28 = __this->get_rb_5();
		NullCheck(L_28);
